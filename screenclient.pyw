...
def display_images():
    global current_zoom # Default zoom level (-50%)
    global is_dragging  # Declare global variables
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                if event.button == 3:
                    # Reset zoom and position if right mouse button is released
                    global current_zoom
